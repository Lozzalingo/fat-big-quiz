  ...
  return (
    <header className="bg-white">
      ...
      {pathname.startsWith("/admin") === false && (
        <div className="h-32 bg-gradient-to-r from-gray-100 via-gray-700 to-gray-900 animate-shimmer flex items-center justify-between px-16 max-[1320px]:px-16 max-md:px-6 max-lg:flex-col max-lg:gap-y-7 max-lg:justify-center max-lg:h-60 max-w-screen-2xl mx-auto">
          <Link href="/">
