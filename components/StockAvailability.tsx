...
// Name of the component: StockAvailability.tsx
// Developer: Aleksandar Kuzmanovic
// Version: 1.0
// Component call: <StockAvailability stock={stock} inStock={inStock} />
...
const StockAvailability = ({ stock, inStock } : { stock: number, inStock: number }) => {
  return (
